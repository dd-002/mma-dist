...
const i=e=>({x:e.clientX,y:e.clientY}),n=()=>({width:window.innerWidth,height:window.innerHeight}),o=()=>navigator.userAgent.toLowerCase().indexOf("firefox")>-1;// Initialize mouse position object
let r={x:0,y:0};// Update 'mousepos' with the current mouse position
const a=e=>{r=i(e)};// Listen for 'mousemove' and 'pointermove' events and update 'mousepos' accordingly
...
window.addEventListener("resize",e=>{c=n()});var d=l("1oYLf");const u=document.querySelector(".cursor"),h=new class{// Initialize DOM and style related properties
