...
s.makeJQueryPlugin(),s},n?n=t(e,o("hobco")):e.imagesLoaded=t(e,e.EvEmitter);// Helper function that lets you dynamically figure out a grid's rows/columns as well as further refine those with "odd" or "even" ones
...
let a=e=>{let t=gsap.utils.toArray(e),r,i=(e,i,s,o)=>{let n=[],a={},l="even"===s,p;for(p in r.forEach((r,s)=>{let o=Math.round(r[e]+r[i]/2),n=a[o];n||(a[o]=n=[]),n.push(t[s])}),a)n.push(a[p]);if((l||"odd"===s)&&(n=n.filter((e,t)=>!(t%2)===l)),o){let e=[];return n.forEach(t=>e.push(...t)),e}return n};return t.refresh=()=>r=t.map(e=>e.getBoundingClientRect()),t.columns=(e,t)=>i("left","width",e,t),t.rows=(e,t)=>i("top","height",e,t),t.refresh(),t};var l=o("cH00A"),p=o("hxuKX");(0,l.gsap).registerPlugin(p.ScrollTrigger);let h=document.querySelectorAll(".grid"),d=(e,t)=>{// Child elements of grid
